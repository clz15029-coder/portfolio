...
メモ: 2026-08-19、ルート直下が煩雑になってきたためファイル整理を実施。制作開始前の初期プラン`portfolio-plan.md`(Jekyll想定など現行実装と食い違う内容)を`docs/archive/`へ移動しアーカイブ扱いに。ほぼ空だった`README.md`を、フォルダ構成・各ドキュメントの役割・ローカル確認方法をまとめた内容に整備。DESIGN.md/PLAN.md/作品の追加方法.mdはCLAUDE.mdの参照ルールに合わせてルート直下のまま維持。
